...
- **Decision:** `FAIL`
- **Git commit:** `7dba5845847bab55a9a1dc0b7f747a47c3e960ab`
- **Generated:** `2026-08-26T07:36:30.950118+00:00`
- **Build:** `git:7dba5845847bab55a9a1dc0b7f747a47c3e960ab`
- **Dataset version/hash:** `qa-production-eval-v1` / `0a906ab55680815fb9c773267e6b29ae6646d31cd7386f0e20241ac22cea4bb2`
- **Runtime config hash:** `9a0f520ab25d09e9eed35fe99ada33c31a0a7de2892217622020b1a62270c62d`
...
| `retrieval.recall10` | PASS | `1.0` | `>= 0.9` | threshold satisfied |
| `retrieval.mrr` | PASS | `1.0` | `>= 0.85` | threshold satisfied |
| `retrieval.ndcg10` | PASS | `0.9553631376267836` | `>= 0.85` | threshold satisfied |
...
| `performance.profile` | PASS | `True` | `== True` | threshold satisfied |
| `performance.measured` | PASS | `True` | `== True` | threshold satisfied |
| `performance.modeSlos` | PASS | `True` | `== True` | threshold satisfied |
| `performance.latency` | PASS | `23862` | `<= maxP95LatencyMs (45000)` | threshold satisfied |
...
`FAIL` — 19/31 frozen gates passed.
