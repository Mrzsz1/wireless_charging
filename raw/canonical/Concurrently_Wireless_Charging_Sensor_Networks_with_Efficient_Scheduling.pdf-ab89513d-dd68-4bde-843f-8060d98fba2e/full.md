...
1: Given: $C_{\mathcal{N}}$ and $\{u_1^i, \ldots, u_M^i | 1 \leq i \leq \mathcal{N}\}$
2: $C_K \leftarrow \phi$
3: while $f(C_K) \neq ME$ do
4: find $S_i \in C_N$ to maximize $f(C_K \cup \{S_i\}) - f(C_K)$
5: $C_K \leftarrow C_K \cup \{S_i\}$
6: end while
...
<table><tr><td></td><td> $S_1$ </td><td> $S_2$ </td><td> $S_3$ </td><td> $S_4$ </td></tr><tr><td> $s_1$ </td><td>4</td><td>0</td><td>0</td><td>1</td></tr><tr><td> $s_2$ </td><td>0</td><td>4</td><td>0</td><td>1</td></tr><tr><td> $s_3$ </td><td>0</td><td>0</td><td>4</td><td>1</td></tr><tr><td> $s_4$ </td><td>0.5</td><td>0.3</td><td>0.2</td><td>1</td></tr></table>
...
1: Given: $C_{\mathcal{N}}$ and $\{u_1^i,\ldots ,u_M^i |1\leq i\leq \mathcal{N}\}$
2: $C_K\gets \{\text{argmax}\sum_{j:s_j\in \mathcal{S}}\sqcap_j^k\}$
3: while $f(C_K)\neq ME$ do
4: find a set containing $\lceil \alpha M\rceil$ sensor nodes that currently have the lowest energy, and denote the set as $\Gamma$
5: find $S_{i}\in C_{\mathcal{N}}$ to maximize $\sum_{j:s_j\in \Gamma}\sqcap_j^k +\alpha \sum_{s_j\in \mathcal{S}}\sqcap_j^k$
6: $C_K\gets C_K\cup \{S_i\}$
7: end while
</div>
...
1: Input: matrix A
2: Partial solution  $J \leftarrow \phi$ 
3: The current energy request  $\{er_{i} = E\}$ 
4: while  $A \neq 0$  do
