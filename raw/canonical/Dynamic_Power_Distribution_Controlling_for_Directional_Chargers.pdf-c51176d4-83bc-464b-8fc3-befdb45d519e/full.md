...
Output: All candidate sensor sets and candidate charging orientations  $\Theta$ 

1 Find the subset of sensors  $S_{j}$  that could possibly cover by charger  $c_{j}$  and the subset of chargers  $C_{i}$  that could possibly cover sensor  $s_{i}$ ;
